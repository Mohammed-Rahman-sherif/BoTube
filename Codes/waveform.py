...
def main():
    ...
    parser.add_argument('audio', type=Path, default="C:\\Users\\smart\\Documents\\Youtube automator\\Audio\\Translated\\ta\\fBFeM.mp3", nargs='?')
    parser.add_argument("out",
                        type=Path,
                        nargs='?',
                        default=Path('C:\\Users\\smart\\Documents\\Youtube automator\\Media\\Waves\\out.mp4'),
