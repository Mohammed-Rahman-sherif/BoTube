...
__all__ = [
    'SAFTExtendedAudioFormat', 'SpeechGrammarRuleStateTransitionType',
    'SVP_16', 'DISPID_SpeechPhraseAlternates',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPRuleChildren',
    'SAFT48kHz8BitMono', 'SpSharedRecognizer',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechXMLRecoResult',
    'ISpNotifySource', 'DISPID_SpeechObjectToken',
    'eLEXTYPE_RESERVED6', 'SpeechVoiceSpeakFlags',
    'DISPID_SGRsCommitAndSave', 'ISpShortcut',
    'DISPID_SPEActualConfidence', 'DISPID_SRIsShared',
    'ISpeechRecoResult2', 'SpMMAudioOut', 'DISPID_SPAsCount',
    'SPCONTEXTSTATE', 'SPAUDIOBUFFERINFO', 'DISPID_SRAudioInput',
    'SpeechRuleState', 'ISpEventSink', 'SPEI_MAX_SR',
    'DISPID_SRRecognizer', 'DISPID_SGRSTsItem', 'ISpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE10', 'SpPhoneticAlphabetConverter', 'SPSUnknown',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTCGetDataKey', 'DISPID_SPRulesCount',
    'DISPID_SGRSTType', 'DISPID_SDKGetStringValue', 'SGDSActive',
    'SAFTGSM610_44kHzMono', 'SREPropertyStringChange',
    'DISPID_SpeechMMSysAudio', 'SPINTERFERENCE_TOOFAST', 'SPSNoun',
    'SpeechGrammarState', 'DISPID_SpeechGrammarRuleState', 'SpVoice',
    'SPEI_UNDEFINED', 'SRADefaultToActive', 'SAFT11kHz16BitStereo',
    'DISPID_SRCEPhraseStart', 'SGPronounciation', 'SPPS_Interjection',
    'SVP_6', 'SGSEnabled', 'SINone', 'SP_VISEME_2', 'SPBO_NONE',
    'SVP_15', 'DISPID_SGRSTRule', 'DISPID_SGRSTWeight',
    'DISPID_SPIRule', 'SRSEDone', 'SVF_Emphasis', 'SVSFNLPSpeakPunc',
    'DISPID_SGRSAddWordTransition', 'SpeechRuleAttributes',
    'SFTSREngine', 'SPEI_RECOGNITION', 'SPPS_Function',
    'DISPID_SVSInputSentencePosition', 'SpeechRecoContextState',
    'ISpeechCustomStream', 'DISPID_SRGCmdLoadFromFile', 'SRARoot',
    'SVPOver', 'DISPID_SPEEngineConfidence', 'ISpeechPhraseElement',
    'SP_VISEME_12', 'DISPID_SPEs_NewEnum',
    '_ISpeechRecoContextEvents', 'SRTSMLTimeout', 'DISPID_SRGCommit',
    'SpeechAudioFormatGUIDWave', 'SAFTCCITT_uLaw_22kHzStereo',
    'SAFT8kHz16BitMono', 'SpeechRecognitionType',
    'SPXMLRESULTOPTIONS', 'SPDKL_LocalMachine', 'DISPID_SPPName',
    'ISpeechObjectToken', 'SP_VISEME_16', 'DISPID_SFSClose',
    'DISPID_SpeechVoice', 'SPRECORESULTTIMES', 'SVESentenceBoundary',
    'SGRSTTWildcard',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_3',
    'DISPID_SADefaultFormat', 'eLEXTYPE_PRIVATE7',
    'ISpeechPhraseProperties', 'SPEI_RESERVED1', 'SPEI_VISEME',
    'SASRun', 'SAFT12kHz8BitStereo', 'eLEXTYPE_LETTERTOSOUND',
    'SPAUDIOSTATUS', 'SPEI_SR_PRIVATE', 'SAFT16kHz16BitMono',
    'SDTRule', 'SPRULESTATE', 'SPRECOSTATE', 'SPGRAMMARWORDTYPE',
    'SAFT11kHz16BitMono', 'SAFT22kHz8BitMono',
    'ISpeechRecoResultTimes', 'STSF_AppData', 'SGRSTTEpsilon',
    'SPVPRI_OVER', 'DISPID_SAFType', 'DISPID_SpeechAudioStatus',
    'IInternetSecurityMgrSite', 'DISPID_SWFEBlockAlign',
    'DISPID_SRCERecognizerStateChange', 'SWPKnownWordPronounceable',
    'ISpMMSysAudio', 'SAFT32kHz16BitStereo',
    'DISPID_SPAStartElementInResult', 'DISPID_SABIBufferSize',
    'SECFDefault', 'DISPID_SOTCId', 'DISPID_SpeechPhraseProperty',
    'ISpRecoGrammar', 'SpeechLoadOption', 'SPRST_NUM_STATES',
    'STCLocalServer', 'DISPID_SRCEPropertyNumberChange',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRGCmdLoadFromObject', 'SpeechVisemeFeature',
    'SDTAlternates', 'DISPID_SVSInputWordPosition', 'SVPNormal',
    'DISPID_SLGetWords', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTADPCM_44kHzMono', 'DISPID_SVSLastResult', 'SVP_14',
    'DISPID_SVSkip', 'DISPID_SOTDisplayUI', 'ISpeechPhraseProperty',
    '_ISpeechVoiceEvents', 'DISPID_SGRsDynamic', 'DISPID_SRStatus',
    'eLEXTYPE_PRIVATE12', 'SpAudioFormat',
    'DISPID_SPERequiredConfidence', 'SPEI_MIN_TTS',
    'SpeechCategoryRecognizers',
    'SpeechPropertyLowConfidenceThreshold', 'ISpXMLRecoResult',
    'SpeechRecoEvents', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRRSaveToMemory', 'ISpeechPhraseAlternates', 'SSFMCreate',
    'DISPID_SRCEEndStream', 'ISpVoice', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPEAudioStreamOffset', 'SpInProcRecoContext',
    'SDKLDefaultLocation', 'DISPID_SVGetAudioOutputs', 'SPWORD',
    'SPINTERFERENCE_NOISE', 'SDTAll', 'SPEI_HYPOTHESIS',
    'DISPID_SOTSetId', 'ISpeechPhraseElements', 'SWTAdded',
    'Speech_Max_Pron_Length', 'DISPID_SRCERecognition',
    'SAFTADPCM_22kHzMono', 'SPPHRASEELEMENT', 'SVEWordBoundary',
    'SpStreamFormatConverter', 'DISPID_SRGSetTextSelection',
    'SPBO_AHEAD', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SOTMatchesAttributes', 'SAFTNoAssignedFormat',
    'SP_VISEME_18', 'SPPS_Modifier', 'SpeechAudioFormatType',
    'SPEI_TTS_PRIVATE', 'SVSFIsXML', 'ISpRecognizer3',
    ...
    'DISPID_SPRuleFirstElement', 'SPVPRI_ALERT',
    'DISPID_SLGetPronunciations', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_PRIVATE18', 'SP_VISEME_15', 'SRSActive',
    'DISPID_SPEPronunciation', 'SRAExport',
    'DISPID_SpeechPhraseProperties', 'DISPID_SVAlertBoundary',
    'SREAllEvents', 'SPEI_SR_AUDIO_LEVEL', 'WAVEFORMATEX',
    'DISPID_SWFEExtraData', 'SpeechAudioFormatGUIDText',
    'DISPID_SLGenerationId', 'SRTExtendableParse',
    'SpeechBookmarkOptions', 'SPEI_SR_BOOKMARK', 'SLTApp',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechWordType',
    'SDA_Two_Trailing_Spaces', 'SpNullPhoneConverter',
    'ISpeechPhraseInfo', 'DISPID_SVVoice', 'DISPID_SLWsItem',
    'SpMMAudioEnum', 'SPDKL_CurrentUser', 'SPBO_TIME_UNITS',
    'SpPhraseInfoBuilder', 'DISPID_SVSpeak', 'DISPID_SVDisplayUI',
    'ISpeechGrammarRule', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_RESERVED4', 'SVF_Stressed', 'SECHighConfidence',
    'DISPID_SRCEHypothesis', 'SPCT_COMMAND', 'SPCT_DICTATION',
    'DISPID_SPIElements', 'SPCT_SUB_DICTATION', 'DISPID_SPRs_NewEnum',
    'SPAR_Unknown', '__MIDL_IWinTypes_0009', 'DISPID_SOTId',
    'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVEVoiceChange',
    'SRAONone', 'SpeechFormatType', 'DISPID_SGRSTs_NewEnum',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_RECO_STATE_CHANGE', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRCEAdaptation',
    'DISPID_SRRDiscardResultInfo', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPILanguageId', 'DISPID_SpeechPhraseElement',
    'ISpeechPhraseInfoBuilder', 'DISPID_SAEventHandle',
    'ISpRecognizer2', 'DISPID_SCSBaseStream', 'SVP_5',
    'eLEXTYPE_PRIVATE2', 'SPGRAMMARSTATE', 'SPINTERFERENCE',
    'SLTUser', 'DISPID_SLPsCount', 'SSFMOpenForRead',
    'SPEI_START_SR_STREAM', 'ISpeechPhoneConverter',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPIGetDisplayAttributes', 'SpStream', 'SpeechAudioState',
    'SGRSTTTextBuffer', 'DISPID_SRGDictationLoad', 'SpeechVisemeType',
    'DISPID_SOTRemove', 'SPFM_NUM_MODES',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPAsItem',
    'SPPS_SuppressWord', 'SGDSActiveUserDelimited',
    'SpeechCategoryAudioOut', 'SPEVENTENUM',
    'DISPID_SpeechPhoneConverter', 'SAFT48kHz16BitMono',
    'DISPID_SGRSTNextState', 'SPSEMANTICFORMAT',
    'DISPID_SPRuleEngineConfidence', 'DISPIDSPTSI',
    'DISPID_SBSFormat', 'DISPID_SGRId', 'DISPID_SVAudioOutputStream',
    'DISPID_SOTCreateInstance', 'SDA_No_Trailing_Space',
    'DISPID_SAVolume', 'ISpeechXMLRecoResult', 'DISPID_SPPValue',
    'SVP_4', 'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRGId',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCSetAdaptationData',
    'SPSERIALIZEDPHRASE', 'SPRULE', 'DISPID_SABufferNotifySize',
    'SRESoundStart', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SAFGuid', 'ISpeechLexiconWord', 'SRAImport',
    'DISPID_SPPParent', 'SpInprocRecognizer', 'ISpDataKey',
    'SLODynamic', 'DISPID_SRCPause', 'SAFTCCITT_ALaw_8kHzMono',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRInitialState',
    'SPFM_OPEN_READONLY', 'DISPID_SLPLangId', 'SAFTADPCM_11kHzMono',
    'DISPID_SWFESamplesPerSec', 'SPBO_PAUSE', 'SpeechStreamFileMode',
    'DISPID_SpeechPhraseAlternate', 'SSTTDictation', 'SREPhraseStart',
    'SP_VISEME_8', 'SAFTGSM610_11kHzMono', 'SPSMF_SAPI_PROPERTIES',
    'SAFT8kHz16BitStereo', 'DISPID_SRRTTickCount', 'SVEAllEvents',
    'SPVPRIORITY', 'SPEI_PHRASE_START', 'SPPHRASE',
    'SpeechRecognizerState', 'DISPID_SRCERequestUI',
    'DISPID_SPPsCount', 'SPRS_ACTIVE', 'DISPID_SGRsCount',
    'SpeechAllElements', 'SVP_8', 'DISPID_SVEBookmark',
    'DISPID_SLWWord', 'DISPID_SDKSetLongValue', 'SVP_1',
    'ISpGrammarBuilder', 'DISPID_SpeechPhraseRule', 'SPSLMA',
    'SpShortcut', 'DISPID_SRSetPropertyString', 'SASStop',
    'SPRST_ACTIVE', 'SpeechGrammarTagUnlimitedDictation', 'SVP_10',
    'SREAudioLevel', 'SVSFParseAutodetect',
    'DISPIDSPTSI_ActiveOffset', 'SAFT32kHz16BitMono',
    'SGRSTTDictation', 'SVEViseme', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRGState', 'SpeechRegistryUserRoot',
    'DISPID_SLAddPronunciation', 'SREInterference',
    'DISPID_SOTGetStorageFileName', 'SpNotifyTranslator',
    'SPWORDLIST', 'SPWT_DISPLAY', 'ISpObjectTokenCategory',
    'SRSActiveAlways', 'SAFT44kHz16BitMono',
    'IInternetSecurityManager', 'DISPID_SpeechPhraseBuilder',
    'SPEI_RESERVED2', 'DISPID_SpeechRecognizer', 'SRCS_Disabled',
    'SAFTGSM610_22kHzMono', 'DISPID_SMSGetData', 'ISpeechRecoContext',
    'SPLEXICONTYPE', 'SDTReplacement', 'SpObjectTokenCategory',
    'SVP_7', 'SPDKL_CurrentConfig', 'SpeechTokenIdUserLexicon',
    'DISPID_SPPsItem', 'SP_VISEME_14', 'SP_VISEME_13',
    'DISPID_SDKDeleteValue', 'SPSHORTCUTTYPE', 'SRERecognition',
    'SAFT16kHz8BitMono', 'SREPrivate',
    'DISPID_SASCurrentSeekPosition', 'SRAORetainAudio',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPPNumberOfElements',
    'SDTDisplayText', 'SPRST_INACTIVE', 'SAFTDefault',
    'DISPID_SDKOpenKey', 'SpeechGrammarTagDictation',
    'SRAInterpreter', 'SpSharedRecoContext', 'SPSSuppressWord',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSVerb', 'ISpeechMMSysAudio', 'SECLowConfidence',
    'DISPID_SpeechLexiconProns', 'DISPID_SDKEnumValues',
    'DISPID_SpeechLexicon', 'SVSFDefault', 'DISPID_SVEAudioLevel',
    'ISpeechMemoryStream', 'DISPID_SVESentenceBoundary',
    'SREStreamStart', 'DISPID_SPELexicalForm', 'SWTDeleted',
    'ISpEventSource', 'DISPID_SRCState', 'DISPID_SLPs_NewEnum',
    'DISPID_SWFEBitsPerSample', 'SAFT24kHz8BitMono',
    'DISPID_SDKCreateKey', 'SpeechEngineProperties',
    'DISPIDSPTSI_SelectionOffset', 'SGDSInactive',
    'DISPID_SRRAlternates', 'SREFalseRecognition',
    'DISPID_SGRAddResource', 'eLEXTYPE_PRIVATE14',
    'SGLexicalNoSpecialChars', 'DISPID_SPERetainedSizeBytes',
    'SpeechInterference', 'DISPID_SPIAudioSizeTime', 'SVP_21',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRGCmdLoadFromMemory', 'SpTextSelectionInformation',
    'DISPID_SRRSetTextFeedback', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPIRetainedSizeBytes', 'SSFMOpenReadWrite',
    'SECFNoSpecialChars', 'DISPID_SVAudioOutput',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SOTCSetId',
    'ISpeechRecoGrammar', 'DISPID_SVSLastBookmark',
    'SpeechCategoryAudioIn', 'ISpeechVoiceStatus', 'SpWaveFormatEx',
    'DISPID_SPEAudioTimeOffset', 'SPGS_DISABLED', 'SP_VISEME_6',
    'SVPAlert', 'Speech_StreamPos_Asap', 'eLEXTYPE_PRIVATE20',
    'ISpeechVoice', 'SpeechTokenValueCLSID', 'ISpeechPhraseRules',
    'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCEPropertyStringChange', 'SPPHRASERULE',
    'SPPS_RESERVED1', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCEStartStream', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCEAudioLevel', 'ISpeechAudioFormat', 'SpMemoryStream',
    'SPEI_END_SR_STREAM', 'DISPID_SGRName', 'SPEVENT',
    'DISPID_SPACommit', 'DISPID_SVEventInterests',
    'SREPropertyNumChange', 'DISPID_SRCEventInterests',
    'DISPID_SABIEventBias', 'ISpSerializeState',
    'DISPID_SASNonBlockingIO', 'DISPID_SABIMinNotification',
    'DISPID_SVPause', 'eWORDTYPE_DELETED', 'SECFIgnoreWidth',
    'SpeechUserTraining', 'DISPID_SRCVoice', 'ISpRecognizer',
    'ISpPhoneticAlphabetSelection', 'DISPID_SABufferInfo',
    'DISPID_SpeechWaveFormatEx', 'SPEI_END_INPUT_STREAM',
    'SpeechTokenKeyUI', 'DISPID_SPPEngineConfidence',
    'SECNormalConfidence', 'DISPID_SGRsCommit',
    'ISpeechGrammarRuleStateTransition', 'SSTTTextBuffer',
    'DISPID_SpeechRecoContext', 'eLEXTYPE_MORPHOLOGY',
    'SPVOICESTATUS', 'SPWORDPRONOUNCEABLE', 'SRTEmulated',
    'DISPID_SRRTStreamTime', 'SDKLLocalMachine', 'SVP_17',
    'SREStreamEnd', 'SpFileStream', 'SPPS_RESERVED3',
    'SSSPTRelativeToEnd', 'DISPID_SpeechVoiceEvent', 'SpeechRunState',
    'DISPID_SPRsItem', 'SPLOADOPTIONS', 'SITooSlow',
    'SVEStartInputStream', 'SVP_20', 'SAFT8kHz8BitMono',
    'DISPID_SPRsCount', 'DISPID_SRCVoicePurgeEvent', 'SPFILEMODE',
    'SpResourceManager', 'SGSDisabled', 'DISPID_SGRAttributes',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPCPhoneToId', 'SpCustomStream',
    'DISPID_SpeechPhraseElements', 'SPAO_NONE', 'SAFT32kHz8BitStereo',
    'STSF_FlagCreate', 'SPSMF_UPS', 'DISPID_SPRuleId',
    'DISPID_SPRuleParent', 'eLEXTYPE_PRIVATE19', 'SPAS_CLOSED',
    'eLEXTYPE_PRIVATE13', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVSLastBookmarkId',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_10',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechAudio',
    'SpeechEngineConfidence', 'DISPID_SWFEAvgBytesPerSec',
    'SPFM_OPEN_READWRITE', 'DISPID_SRGetRecognizers',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecoGrammar2', 'SPWT_PRONUNCIATION', 'DISPID_SLPSymbolic',
    'SPLO_STATIC', 'SPEI_INTERFERENCE', 'DISPID_SOTCDefault',
    ...
    'DISPID_SOTDataKey', 'DISPID_SPEsItem', 'eLEXTYPE_PRIVATE4',
    'SPTEXTSELECTIONINFO', 'DISPID_SDKSetBinaryValue',
    'SAFT48kHz8BitStereo', 'ISpNotifySink', 'DISPID_SWFEFormatTag',
    'DISPID_SFSOpen', 'ISpeechAudio',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRGetPropertyString',
    'ISpeechGrammarRules', 'SpeechGrammarTagWildcard', 'SVP_19',
    'SpeechVoiceSkipTypeSentence', 'SPAR_Medium', 'DISPID_SPCLangId',
    'ISpeechResourceLoader', 'DISPID_SGRSTsCount',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechAudioBufferInfo',
    'SPEI_REQUEST_UI', 'eLEXTYPE_APP', 'SVSFlagsAsync',
    'SAFT8kHz8BitStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPPS_NotOverriden', 'SPAS_RUN', 'SRTAutopause', 'DISPID_SBSRead',
    'SVP_18', 'SAFT12kHz8BitMono', 'SP_VISEME_3', 'SPSHT_Unknown',
    'SVEVoiceChange', 'SpeechPropertyAdaptationOn', 'SPSModifier',
    'DISPID_SDKGetlongValue', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechAudioFormat', 'Speech_Max_Word_Length',
    'SDKLCurrentConfig', 'DISPID_SVSRunningState', 'SP_VISEME_21',
    'DISPID_SPPId', 'DISPID_SLPPhoneIds',
    'SpeechStreamSeekPositionType', 'DISPID_SVEWord',
    'DISPID_SpeechLexiconWords', 'ISpeechAudioStatus',
    'DISPID_SRCEBookmark', 'DISPID_SRCRecognizer', 'SGDisplay',
    'eLEXTYPE_PRIVATE3', 'SPDATAKEYLOCATION',
    'DISPID_SRRGetXMLResult', 'tagSPTEXTSELECTIONINFO',
    'SpeechPropertyHighConfidenceThreshold', 'SDKLCurrentUser',
    'DISPID_SRCESoundStart', 'DISPID_SPRDisplayAttributes',
    'ISpeechObjectTokenCategory', 'DISPID_SASFreeBufferSpace',
    'SPINTERFERENCE_TOOQUIET', 'SRSEIsSpeaking', 'SECFIgnoreKanaType',
    'SpLexicon', 'SAFT12kHz16BitStereo', 'ISpStreamFormat',
    'SITooFast', 'DISPID_SOTGetAttribute', 'Speech_Default_Weight',
    'SPLO_DYNAMIC', 'ISpRecoContext', 'DISPID_SMSAMMHandle',
    'DISPID_SRGRecoContext', 'DISPID_SVStatus', 'SPRS_INACTIVE',
    'DISPID_SPPConfidence', 'DISPID_SRRTOffsetFromStart',
    'SpPhoneConverter', 'DISPID_SPAPhraseInfo',
    'DISPID_SRRAudioFormat', 'ISpLexicon', 'SGSExclusive',
    'DISPID_SLWs_NewEnum', 'STCInprocHandler', 'ISpeechRecoResult',
    'SAFTADPCM_8kHzMono', 'SGRSTTWord', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRGReset', 'SpCompressedLexicon', 'DISPID_SRSClsidEngine',
    'SPPS_RESERVED4', 'DISPID_SPCIdToPhone', 'SAFT12kHz16BitMono',
    'SP_VISEME_20', 'SDTLexicalForm', 'SAFT48kHz16BitStereo',
    'DISPID_SAFSetWaveFormatEx', 'tagSPPROPERTYINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechBaseStream',
    'SBOPause', 'SPSHT_OTHER', 'SAFTCCITT_ALaw_11kHzStereo',
    'SECFIgnoreCase', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechBaseStream', 'SPSInterjection',
    'DISPID_SPRuleConfidence', 'DISPID_SAStatus', 'SPVPRI_NORMAL',
    'SpeechRecoProfileProperties', 'SPSTREAMFORMATTYPE',
    'SpeechAudioProperties', 'SITooLoud',
    'SPEI_PROPERTY_STRING_CHANGE', 'IStream', 'SpMMAudioIn',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SOTGetDescription',
    'DISPID_SRRGetXMLErrorInfo', 'SRESoundEnd',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SVGetProfiles',
    'DISPID_SPIStartTime', 'SPPARTOFSPEECH',
    'SpeechDictationTopicSpelling', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_USER', 'SAFT16kHz16BitStereo', 'SP_VISEME_7',
    'SRTStandard', 'SVEPhoneme', 'SBONone',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechGrammarRule', 'SpeechCategoryAppLexicons',
    'SPWT_LEXICAL', 'SDA_One_Trailing_Space',
    'DISPID_SpeechFileStream', 'STCInprocServer',
    'DISPID_SpeechRecoResultTimes', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SMSSetData', 'ISpeechLexiconWords', 'SVSFParseSapi',
    'STCAll', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCRetainedAudioFormat',
    'SREStateChange', 'SAFT44kHz8BitMono',
    'DISPID_SRGDictationSetState', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPINTERFERENCE_NONE', 'ISpObjectToken', 'SpeechMicTraining',
    'DISPID_SPRules_NewEnum', 'SFTInput', 'DISPID_SVEStreamEnd',
    'SPPS_Noncontent', 'DISPID_SLWsCount', 'SPAO_RETAIN_AUDIO',
    'ISpeechTextSelectionInformation', 'DISPID_SOTCategory',
    'ISpeechAudioBufferInfo', 'DISPID_SVSpeakStream',
    'SPEI_VOICE_CHANGE', 'ISpAudio', 'SAFT22kHz16BitStereo',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechGrammarRules',
    'SVEPrivate', 'SVSFParseMask', 'DISPID_SGRSAddRuleTransition',
    'eLEXTYPE_RESERVED8', 'DISPID_SpeechMemoryStream',
    'SWPUnknownWordPronounceable', 'SAFT22kHz8BitStereo',
    'SGRSTTRule', 'DISPID_SRRRecoContext', 'DISPID_SOTs_NewEnum',
    'SAFT22kHz16BitMono', 'SpeechTokenContext',
    'DISPID_SPIProperties', 'ISpeechPhraseAlternate', 'SP_VISEME_0',
    'DISPID_SGRSRule', 'DISPID_SpeechRecoResult2',
    'DISPID_SPPs_NewEnum', 'eLEXTYPE_RESERVED9',
    'DISPID_SRSCurrentStreamPosition', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPEsCount', 'STCRemoteServer', 'SP_VISEME_17',
    'IEnumString', 'SAFTADPCM_44kHzStereo', 'DISPID_SMSALineId',
    'SpeechTokenKeyFiles', 'SPPHRASEPROPERTY',
    'DISPID_SOTIsUISupported', 'SPEI_RESERVED3',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRRSpeakAudio',
    'SAFT11kHz8BitMono', 'SPVISEMES', 'DISPID_SLPsItem',
    'DISPID_SASetState', 'SpeechGrammarWordType',
    'SpeechPropertyResourceUsage', 'SRATopLevel',
    'DISPID_SWFEChannels', 'DISPID_SVRate', 'SP_VISEME_4',
    'ISequentialStream', 'ISpeechFileStream', 'SPXRO_SML',
    'SpeechLexiconType', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SGRs_NewEnum', 'SDTPronunciation',
    'DISPID_SVEStreamStart', 'DISPID_SVEEnginePrivate', 'SVSFNLPMask',
    'ISpeechPhraseRule', 'DISPID_SPIGetText', 'DISPID_SGRClear',
    'ISpeechGrammarRuleStateTransitions', 'SVEEndInputStream',
    'DISPID_SpeechObjectTokens', 'SPPS_RESERVED2',
    'DISPID_SVWaitUntilDone', 'SVEBookmark', 'SPPS_Verb',
    'SAFTNonStandardFormat', 'DISPID_SPAs_NewEnum',
    'DISPID_SRCEInterference', 'SpeechCategoryPhoneConverters',
    'DISPID_SRRPhraseInfo', 'ISpPhoneticAlphabetConverter',
    'SPAR_Low', 'SRCS_Enabled', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSVisemeId', 'DISPID_SpeechLexiconWord',
    'SAFT44kHz16BitStereo', 'SVEAudioLevel', 'SP_VISEME_1',
    'SRERecoOtherContext', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVIsUISupported',
    'DISPID_SpeechCustomStream', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPISaveToMemory',
    'SPPHRASEREPLACEMENT', 'SPFM_CREATE', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVVolume', 'DISPID_SPPFirstElement', 'eLEXTYPE_PRIVATE9',
    'eWORDTYPE_ADDED', 'SPWORDPRONUNCIATION', 'DISPID_SRProfile',
    'SPAS_PAUSE', 'DISPID_SRCCreateResultFromMemory',
    'SPBOOKMARKOPTIONS', 'DISPID_SpeechPhraseInfo',
    'DISPID_SMSADeviceId', '_SPAUDIOSTATE', 'DISPID_SVEPhoneme',
    'LONG_PTR', 'DISPID_SRRAudio', 'SpeechAddRemoveWord',
    'DISPID_SRIsUISupported', 'SRERequestUI', 'SVSFUnusedFlags',
    'ISpeechLexicon', 'SDA_Consume_Leading_Spaces', 'UINT_PTR',
    'SRSInactive', 'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRCResume',
    'SPSFunction', 'DISPID_SGRsFindRule', 'DISPID_SGRSTransitions',
    'DISPID_SGRAddState', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVGetAudioInputs',
    'eLEXTYPE_RESERVED7', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPEI_MAX_TTS', 'DISPID_SRCESoundEnd',
    'DISPID_SPRNumberOfElements', 'SpeechVoiceEvents',
    'DISPID_SRGRules', 'SVSFParseSsml',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRsItem', 'SAFTText',
    ...
    'SpeechDisplayAttributes', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRSCurrentStreamNumber', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_SENTENCE_BOUNDARY',
    'SPRECOGNIZERSTATUS', 'SPWORDTYPE', 'DISPID_SLWPronunciations',
    'ISpeechLexiconPronunciation', 'DISPID_SPEAudioSizeTime',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPRuleName',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRRTLength',
    'ISpeechGrammarRuleState', 'DISPIDSPTSI_ActiveLength',
    'SPPS_Noun', 'eLEXTYPE_PRIVATE11', 'DISPID_SGRSTPropertyValue',
    'SPSHT_EMAIL', 'SpObjectToken', 'SPEI_SOUND_END',
    'DISPID_SVSCurrentStreamNumber', 'SVP_9', 'SAFT16kHz8BitStereo',
    'SPAUDIOSTATE', 'DISPID_SGRSTText', 'DISPID_SRDisplayUI',
    'SPXRO_Alternates_SML', 'SGDSActiveWithAutoPause',
    'SAFT11kHz8BitStereo', 'SPSNotOverriden', 'SREBookmark',
    'SPDKL_DefaultLocation', 'STSF_CommonAppData',
    'DISPID_SRSAudioStatus', 'SPCATEGORYTYPE',
    'DISPID_SPRFirstElement', 'SPEI_ADAPTATION', 'DISPIDSPRG',
    'ISpeechPhraseReplacements', 'DISPID_SPIGrammarId',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_9', 'ISpRecoContext2',
    'SP_VISEME_11', 'DISPID_SVSPhonemeId',
    'DISPID_SRCAudioInInterferenceStatus', 'SDTProperty',
    'SVSFVoiceMask', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SOTsCount',
    'SpeechTokenKeyAttributes', 'STSF_LocalAppData', 'SGLexical',
    'SVF_None', 'DISPID_SGRsAdd', 'DISPID_SPIEngineId',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_PHONEME', 'DISPID_SVEViseme', 'SP_VISEME_19',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SOTsItem', 'SLOStatic',
    'SVP_12', 'DISPID_SDKDeleteKey', 'ISpObjectWithToken',
    'SpeechDataKeyLocation', 'SVP_13', 'SPWAVEFORMATTYPE',
    'DISPID_SRCBookmark', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCCreateGrammar', 'SPWF_INPUT', 'SRADynamic',
    'SPADAPTATIONRELEVANCE', 'SPAS_STOP', 'SPEI_RESERVED6',
    'SINoSignal', 'ISpRecoCategory', 'SPEI_TTS_BOOKMARK',
    ...
    'ISpPhrase', 'DISPID_SBSSeek', 'eLEXTYPE_RESERVED10',
    'SPSHORTCUTPAIRLIST', 'SpeechRegistryLocalMachineRoot',
    'SPINTERFERENCE_TOOLOUD', 'SVSFIsFilename',
    'DISPID_SPIReplacements', 'DISPID_SPEDisplayText',
    'DISPID_SpeechPhraseRules', 'SpeechDiscardType', 'SP_VISEME_5',
    'ISpResourceManager', 'DISPID_SRGSetWordSequenceData',
    'ISpeechPhraseReplacement', 'SPCT_SLEEP', 'SPWF_SRENGINE',
    'SITooQuiet', 'SPBINARYGRAMMAR', 'SPEI_RESERVED5',
    'DISPID_SDKGetBinaryValue', 'DISPID_SDKSetStringValue',
    'tagSTATSTG', 'DISPID_SLRemovePronunciation',
    'SAFTGSM610_8kHzMono', 'SpeechSpecialTransitionType',
    'DISPID_SDKEnumKeys', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRRTimes', 'SVP_11',
    'DISPID_SVPriority', 'DISPID_SRGetFormat',
    'SpeechCategoryRecoProfiles', 'SSFMCreateForWrite',
    'SPGS_ENABLED', 'SpeechCategoryVoices', 'SPPROPERTYINFO',
    'SREHypothesis', 'SPAR_High', 'SASClosed', 'SPSERIALIZEDRESULT',
    'SpeechVoicePriority', 'DISPID_SREmulateRecognition',
    'DISPID_SASState', 'DISPID_SVSInputWordLength', 'DISPID_SRState',
    'SPCT_SUB_COMMAND', 'SVP_0', 'DISPID_SRGetPropertyNumber',
    'SVSFPersistXML', 'ISpPhoneConverter', 'SASPause',
    'DISPID_SPRText', 'DISPID_SPARecoResult', 'SVSFIsNotXML',
    'SPEVENTSOURCEINFO', 'DISPID_SPRulesItem', 'SREAdaptation',
    'ISpProperties', 'SPEI_FALSE_RECOGNITION', 'SRSInactiveWithPurge',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRGIsPronounceable',
    'SPPS_LMA', 'DISPID_SRCEEnginePrivate', 'ISpeechObjectTokens',
    'ISpPhraseAlt', 'DISPID_SAFGetWaveFormatEx',
    'SpUnCompressedLexicon', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPPChildren', 'SAFTADPCM_8kHzStereo', 'ISpRecoResult',
    'DISPID_SpeechRecoResult', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechRecognizer', 'SpeechRetainedAudioOptions', 'SINoise',
    'IEnumSpObjectTokens', 'ISpeechDataKey', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRAudioInputStream', 'SRTReSent', 'SpeechPartOfSpeech',
    '_RemotableHandle', 'SSTTWildcard', 'DISPID_SGRSTPropertyId',
    'SAFTCCITT_ALaw_44kHzMono', 'SVP_2', 'SPPS_Unknown',
    'SPCS_DISABLED', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHORTCUTPAIR',
    'SpeechWordPronounceable', 'SECFEmulateResult', 'SPEI_MIN_SR',
    'SPAUDIOOPTIONS', 'DISPID_SPRuleNumberOfElements',
    'SSSPTRelativeToStart', 'DISPID_SLPType', 'SPCS_ENABLED',
    'ISpStream', 'DISPID_SLWType', 'SPEI_SOUND_START',
    'SpeechTokenShellFolder', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SVGetVoices', 'DISPID_SGRSTPropertyName',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SVResume', 'ISpNotifyTranslator',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPGS_EXCLUSIVE',
    'DISPID_SRCreateRecoContext', 'DISPID_SLGetGenerationChange'
]

_check_version('1.1.14', 1652451211.609111)
